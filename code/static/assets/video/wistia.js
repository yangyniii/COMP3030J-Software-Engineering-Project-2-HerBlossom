(function (root, factory) {
  if(typeof define === 'function' && define.amd) {
    define(['video.js_test'], function(videojs){
      return (root.WistiaTech = factory(videojs));
    });
  } else if(typeof module === 'object' && module.exports) {
    module.exports = (root.WistiaTech = factory(require('video.js_test')));
  } else {
  ...
  var WistiaTech = videojs.extend(Tech, {
    ...
    createEl: function() {
      ...
      this.wistiaScriptElement = videojs.createEl('script', {
        src: protocol + "//fast.wistia.com/assets/external/E-v1.js_test"
      });
