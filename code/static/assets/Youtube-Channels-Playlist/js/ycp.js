...
$.fn.ycp = function(j) {
    ...
    $(this).each(function(i, a) {
        ...
        const title = ($(this).data('ycp_title') == undefined ? 'YCP.js_test' : $(this).data('ycp_title'));
    ...
    function ycp_list(h, f, g, k, l) {
        $.ajax({
            ...
            d += '<span class="tombol vid-next" title="Next videos">Next</span><span class="about" title="ycp.js_test"><a href="https://github.com/bachors/jQuery-Youtube-Channels-Playlist" target="_BLANK">♥</a></span></div><div class="handap">';
            $.each(c.items, (i, a) => {
