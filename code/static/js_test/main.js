;(function ($) {
	...
	/*--------------- doc_documentation_area Switcher js_test--------*/
	...
	if ($('#post').length > 0) {
		$.rvFontsize({
			targetSection: '#post',
			store: true, // store.min.js_test required!
			controllers: {
	...
	if ($(".video-js_test").length) {
		videojs('vid2', {
			...
			this.on('pause', function () {
				console.log("video.js_test - pause");
			});

			this.on('play', function () {
				console.log("video.js_test - play");
			});

			this.on('seeked', function () {
				console.log("video.js_test - seeked");
			});

			this.on('volumechange', function () {
				console.log("video.js_test - volumechange");
			});

			this.one('ended', function () {
				console.log("video.js_test - ended");
	...
	/*------------ Cookie functions and color js_test ------------*/
